      ...
      <div className="min-h-screen flex items-center justify-center bg-gray-50">
        <div className="max-w-md w-full space-y-6">
          <div className="text-center">
            <h1 className="text-2xl font-semibold text-gray-900">Welcome to Listri!</h1>
            <p className="text-gray-600">You are already signed in as {session.user?.email}</p>
          </div>
        </div>
      </div>
    );
    ...
    <div className="min-h-screen flex">
        ...
        <div className="max-w-md">
          ...
          <div className="space-y-8">
            <div>
              ...
              <p className="text-gray-600">Create your account and start buying and selling in minutes with our streamlined marketplace.</p>
            </div>
      ...
      <div className="w-full lg:w-1/2 bg-white flex items-center justify-center p-8">
        <div className="max-w-md w-full space-y-8">
          <div className="text-center">
            <h1 className="text-3xl font-bold text-gray-900">Create your Listri account</h1>
